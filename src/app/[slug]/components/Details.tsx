...
const Table = ({
  ...
  return (
    <div className="w-max h-max flex items-start justify-center flex-row gap-24">
...
const Details = ({ details, location, properties }: DetailsProps) => {
  ...
  return (
    <article className="w-full h-max flex items-center justify-center flex-col gap-24">
      <div className="w-full h-max flex items-center justify-center text-justify flex-col gap-6">
        <Title className="flex flex-row items-center gap-3 text-black text-3xl font-bold">
          <RiMapPinLine size={40} className="text-black" />
          Ubicacion
        </Title>
        <p className="w-[40%] text-black/80 text-base font-normal">
          {location}
        </p>
      </div>
      {properties && (
      ...
      <div className="w-full h-max flex items-center justify-center flex-col gap-6">
        <h4 className="flex flex-row items-center gap-3 text-black text-3xl font-bold">
        ...
        <ul className="w-[40%] flex flex-col gap-4">
          {details.map((detail, index) => (
            <li
              key={index}
              className="text-black text-base font-normal flex items-center justify-start flex-row gap-2"
            >
