    ...
    <div className="w-full h-max flex items-center justify-center">
      ...
      >
        <div className="w-full h-full">
          <footer className="absolute bottom-0 w-full h-1/3 xxl:h-[40%] bg-black/95 rounded-b-[32px] flex items-center justify-center">
            <div className="w-[90%] h-max flex flex-col gap-4 xxl:gap-2">
              <h5 className="text-white text-2xl sm:text-xl font-semibold">{title}</h5>
              <p className="w-3/4 sm:w-full text-white/60 xxl:text-sm">{description}</p>
